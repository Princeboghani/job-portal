        ...
        <div className="flex gap-2 mb-6 mt-3">
          {isEdit||userData && userData.resume === "" ? (
            ...
            <div className="flex gap-2">
              ...
              <button onClick={e=>(setIsEdit(true))} className="text-gray-500 border border-gray-300 rounded-lg px-4 py-2">Edit</button>
            </div>
          )}
        </div>
        <h2 className="text-xl font-semibold mb-4">Jobs Applied</h2>
        <table className="min-w-full bg-white boredr rounded-lg">
          <thead>
            <tr>
              <th className="py-3 px-4 border-b text-left">Company</th>
              <th className="py-3 px-4 border-b text-left">Job Titel</th>
